// Automatically created by 'sqlite auto migrator (SAM)' on 2026-03-02T07:53:45.638Z
...
export const PRAGMAS = {
	...
	count_changes: 0,
	data_version: 1,
	file: "/private/var/folders/h7/_zhk66ds6q5ghs4f0l77ntjh0000gn/T/x3Cz2e/temp.db",
...
export async function up(db) {
	await db.run(
		"CREATE TABLE coding_agent_turns(id TEXT PRIMARY KEY,execution_process_id TEXT NOT NULL UNIQUE REFERENCES execution_processes(id),agent_session_id TEXT,agent_message_id TEXT,prompt TEXT,summary TEXT,seen INTEGER NOT NULL DEFAULT 0,created_at TEXT NOT NULL DEFAULT(datetime('now')),updated_at TEXT NOT NULL DEFAULT(datetime('now')))",
	);
	await db.run(
		"CREATE INDEX idx_coding_agent_turns_agent_session ON coding_agent_turns(agent_session_id)",
	);
	await db.run(
		"CREATE INDEX idx_coding_agent_turns_execution_process ON coding_agent_turns(execution_process_id)",
	);
}
