// Automatically created by 'sqlite auto migrator (SAM)' on 2026-03-27T19:14:24.158Z
...
export async function up(db) {
    await db.run("ALTER TABLE \"workspace_repos\" ADD COLUMN \"pr_url\" TEXT");
}
...
export async function down(db) {
    await db.run("ALTER TABLE \"workspace_repos\" DROP COLUMN \"pr_url\"");
}