// Automatically created by 'sqlite auto migrator (SAM)' on 2026-03-13T13:20:02.850Z
...
export async function up(db) {
    await db.run("ALTER TABLE \"workspaces\" ADD COLUMN \"attempt\" INTEGER NOT NULL DEFAULT 1");
    await db.run("ALTER TABLE \"workspaces\" ADD COLUMN \"archived\" INTEGER NOT NULL DEFAULT 0");
...
export async function down(db) {
    ...
    await db.run("ALTER TABLE \"workspaces\" DROP COLUMN \"attempt\"");
    await db.run("ALTER TABLE \"workspaces\" DROP COLUMN \"archived\"");
}