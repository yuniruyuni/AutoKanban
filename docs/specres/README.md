...
- 個人開発者が、Claude Code / Gemini CLI / Codex CLI などの AI コーディングエージェントを複数並行で走らせながら、
...
| 用途 | 実装 |
|---|---|
| AI Agent 定義 | `server/src/models/agent/` |
| AI Executor (Claude Code / Gemini CLI / Codex CLI) | `server/src/repositories/executor/`, `server/src/infra/executor/` |
...
| [`agent/`](./agent/) | Coding Agent の種類・capability・parser・default variants |
...
| Agent | [agent_is_the_coding_agent_definition](./agent/agent_is_the_coding_agent_definition.md) |
